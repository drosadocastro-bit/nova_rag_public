...
- [📈 Test Coverage Snapshot](#-test-coverage-snapshot)
- [🎯 Why NIC?](#-why-nic)
- [CI](#ci)
- [Purpose](#purpose)
- [📊 NIC vs. Alternatives](#-nic-vs-alternatives)
- [Intended Audience](#intended-audience)
- [Key Properties](#key-properties)
- [Claims → Evidence](#claims--evidence)
- [Design Journey: From Prototype to Production](#design-journey-from-prototype-to-production)
- [Phase 2: Production Scaling Architecture (Jan 2026)](#phase-2-production-scaling-architecture-jan-2026)
- [Documentation](#documentation)
- [🌳 Deployment Decision Tree](#-deployment-decision-tree)
- [Quick Start](#quick-start)
   - [Option 1: Docker (Recommended)](#option-1-docker-recommended)
   - [Option 2: Local Installation](#option-2-local-installation)
- [LLM Models In Use](#llm-models-in-use)
- [Corpus & Domain Coverage](#corpus--domain-coverage)
...
- [Phase 2: Safety-Hardened Retrieval](#phase-2-safety-hardened-retrieval)
   - [What's New](#whats-new)
- [Phase 2.5: Enhanced Multi-Domain Retrieval](#phase-25-enhanced-multi-domain-retrieval)
   - [What's New](#whats-new-1)
- [Phase 3: Scalability & Real-World Corpus ✅ COMPLETE](#phase-3-scalability--real-world-corpus--complete)
   - [What Was Built](#what-was-built)
- [Phase 3.5: Neural Advisory Layer ✅ COMPLETE](#phase-35-neural-advisory-layer--complete)
   - [Implementation Progress](#implementation-progress)
- [Domain Isolation Milestone ✅ COMPLETE (Jan 2026)](#domain-isolation-milestone--complete-jan-2026)
- [Post-Generation Quality Gate ✅ FROZEN (Feb 2026)](#post-generation-quality-gate--frozen-feb-2026)
- [Adversarial Quality Gate Testing](#adversarial-quality-gate-testing)
...
- [Troubleshooting Guide](#troubleshooting-guide)
   - [Symptom: High Latency (> 500ms per query)](#symptom-high-latency--500ms-per-query)
   - [Symptom: Low Retrieval Scores (< 0.55)](#symptom-low-retrieval-scores--055)
   - [Symptom: Cross-Domain Contamination (wrong domain in results)](#symptom-cross-domain-contamination-wrong-domain-in-results)
   - [Symptom: Out of Memory (OOM) During Indexing](#symptom-out-of-memory-oom-during-indexing)
   - [Symptom: Stale Results (corpus was updated but old results returned)](#symptom-stale-results-corpus-was-updated-but-old-results-returned)
