...
- Optimization and tuning guides (e.g., OPTIMIZATION_GUIDE.md)

## Naming Guidance
Where possible, filenames aim to be neutral and descriptive. If you plan external review, prefer terms like:
- "Maintenance Log" over "Cleanup Summary"
- "Engineering Log" over "Development Journal"
- "Release Readiness Checklist" over "GitHub Release Ready"

We can rename or regroup specific files upon request; links in annex documents will be updated accordingly.
