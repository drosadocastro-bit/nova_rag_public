...
class MultiDomainIngester:
    ...
    def __init__(self, embedding_model: str = 'all-MiniLM-L6-v2'):
        ...
        self.pdf_extractor = RobustPDFExtractor(verbose=False)

    def extract_text_from_pdf(self, pdf_path: Path) -> Tuple[str, str, List[str]]:
        """
        Extract text from PDF using robust multi-method extractor.
        Returns (text, extraction_method, methods_attempted)
        """
        text, method, methods = self.pdf_extractor.extract_text(pdf_path)
